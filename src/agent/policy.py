...
"""
Input tensor is 8x8x14, representing the board itself and different types of pieces and colors (+2 for castling)
"""
INPUT_CHANNELS = 14
...
class PolicyNetwork(nn.Module):
    def __init__(self, num_filters = 128, num_res_layers = 11):
        ...
        self.conv1 = nn.Conv2d(14, self.num_filters, kernel_size = 5, stride = 1, padding = 2)
